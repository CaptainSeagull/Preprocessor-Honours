...
template<typename T> static char const *type_to_string(void) {
    Type<T> t = {};
    return(t.name);
}

template<typename T> static char const *weak_type_to_string(void) {
    Type<T> t = {};
    return(t.weak_name);
}

template<typename T> static size_t get_member_count(void) {
    Type<T> t = {};
    return(t.member_count);
}
template<typename T> static MetaType is_pointer(void) {
    Type<T> t = {};
    return(t.is_pointer);
}
